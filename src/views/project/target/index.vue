<template>
  <div class="p-3">
    ...
    <el-card shadow="hover">
      ...
      <el-table ref="targetTableRef" v-loading="loading" :data="projectList" border style="width: 100%" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column label="项目名称" :resizable="false" prop="assignedSubjectName" width="200px" :show-overflow-tooltip="true" fixed="left">
        </el-table-column>
        ...
        <el-table-column label="负责课题" :resizable="false" prop="assignedSubjectSection" :show-overflow-tooltip="true" width="150">
        </el-table-column>
        ...
        <el-table-column label="科研项目管理人" :resizable="false" prop="researchManager" :show-overflow-tooltip="true" width="180">
        </el-table-column>
        <el-table-column label="立项时间" :resizable="false" prop="projectEstablishTime" width="170"> </el-table-column>
        <el-table-column label="项目计划验收时间" :resizable="false" prop="projectScheduledCompletionTime" :show-overflow-tooltip="true" width="170">
        </el-table-column>
...
const { pro_level_type, pro_cooperative_unit, pro_progress_status } = toRefs<any>(
  proxy?.useDict('pro_level_type', 'pro_cooperative_unit', 'pro_progress_status')
);
