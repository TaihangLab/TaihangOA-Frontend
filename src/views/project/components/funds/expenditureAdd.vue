          ...
          <el-col :span="12">
            <el-form-item label="一级科目" prop="firstLevelSubject">
              <el-select v-model="form.firstLevelSubject" placeholder="请选择一级科目">
                <el-option v-for="item in firstLevelSubjectOptions" :key="item.firstLevelSubjectId" :label="item.firstLevelSubjectName" :value="item.firstLevelSubjectId"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="二级科目" prop="secondLevelSubject">
              <el-select v-model="form.secondLevelSubject" placeholder="请选择二级科目">
                <el-option v-for="item in secondLevelSubjectOptions" :key="item.secondLevelSubjectId" :label="item.secondLevelSubjectName" :value="item.secondLevelSubjectId"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="日期" prop="expenditureDate">
              <el-col :span="11">
                <el-date-picker type="date" placeholder="选择日期" v-model="form.expenditureDate" style="width: 192px" value-format="yyyy-MM-dd"></el-date-picker>
              </el-col>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12">
            <el-form-item label="三级科目" prop="thirdLevelSubject">
              <el-select v-model="form.thirdLevelSubject" placeholder="请选择三级科目">
                <el-option v-for="item in thirdLevelSubjectOptions" :key="item.thirdLevelSubjectId" :label="item.thirdLevelSubjectName" :value="item.thirdLevelSubjectId"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
