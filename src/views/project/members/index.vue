  ...
  <div class="p-2">
    ...
    <el-card shadow="hover">
      ...
      <el-table ref="roleTableRef" v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="姓名" fixed="left" prop="roleName" :show-overflow-tooltip="true" width="150" />
        <el-table-column label="所属公司" prop="roleName" :show-overflow-tooltip="true" width="150" />
        <el-table-column label="所属部门" prop="roleName" :show-overflow-tooltip="true" width="150" />
        <el-table-column label="职称" prop="roleName" :show-overflow-tooltip="true" width="150" />
        <el-table-column label="学历" prop="roleName" :show-overflow-tooltip="true" width="150" />
