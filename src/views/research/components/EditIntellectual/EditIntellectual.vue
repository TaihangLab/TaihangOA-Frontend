  ...
  <div>
    ...
    <el-form ref="formAdd" :model="ipParams" label-width="120px">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="关联项目名称" prop="responseProject">
            ...
            :options="projectOptions" clearable 
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="获得日期" prop="ipDate">
            <el-date-picker type="date" placeholder="选择日期" v-model="ipParams.ipDate" style="width: 192px"
        ...
        <el-col :span="12">
          <el-form-item label="知识产权成员" prop="responsePerson">
            <el-cascader v-model="responsePerson" 
            :options="userOptions" 
            :props="{
              multiple: true,
              checkStrictly: true,
      ...
      <el-form-item label="附件">
        <file-upload ref="fileUpload" :idList="ossIds" />
      </el-form-item>
      <!-- 提交按钮 -->
...
const onSubmit = () => {
  ...
  // 调用更新函数
  api.updateIntellectualProperty(data.ipParams).then(response => {
