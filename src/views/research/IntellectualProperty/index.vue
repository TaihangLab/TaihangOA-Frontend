      ...
      <el-table ref="roleTableRef" v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column fixed="right" label="操作" min-width="10%">
          <template #default="scope">
            ...
            <el-tooltip v-if="scope.row.roleId !== 0" content="删除" placement="top-end">
              <el-button v-hasPermi="['system:role:edit']" link type="primary" icon="Delete" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { ref } from 'vue';
import IpDetailDialog from '@/views/research/IntellectualProperty/ipDetailDialog.vue';
