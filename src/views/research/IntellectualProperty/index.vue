  ...
  <div class="p-2">
    ...
    <div v-show="showSearchRef" class="mb-[10px]">
      ...
      <!-- 新增 -->
        ...
        <el-row :gutter="10">
          <el-col :span="1.5">
              <el-button type="primary" plain icon="Plus"  @click="handleAdd" v-hasPermi="['project:ip:add']">新增
              </el-button>
          </el-col>
          ...
          <div>
              <el-table ref="multipleTable" :data="iplist" border style="width: 100%" :row-style="{ height: '50px' }"
                  ...
                  <!-- 知识产权类别 -->
                  <el-table-column label="知识产权类别" :resizable="false" align="center" prop="ipType" 
                                   width="200">
                ...
                {{ ip_status[scope.row.ipStatus]?.label || '未知' }}
                  ...
                  <el-table-column label="操作" :resizable="false" align="center" min-width="200px" fixed="right">
                      <template v-slot="scope">
                          ...
                          <el-button  type="text" icon="Edit" @click="handleUpdate(scope.row.ipId)" v-hasPermi="['project:ip:update']">
                          </el-button>
                        </el-tooltip>
                          <!-- 删除 -->
                          <el-tooltip content="删除" placement="top">
                          <el-button  type="text" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['project:ip:delete']">
                          </el-button>
                        </el-tooltip>
                      </template>
                  </el-table-column>
              ...
              <!-- 详情打开的界面 -->
              <el-dialog title="详情" v-model = "dialogIntellectualLook" destroy-on-close width="50%">
                  <GetIntellectualDetails :ipId="Number(ipId)" @close-dialog="closeIntellectualDialogLook"></GetIntellectualDetails>
              </el-dialog>
              <!--新增知识产权-->
              <el-dialog title="新增知识产权" v-model = "intellectualDialogVisibleAdd" destroy-on-close width="700px" >
                  <AddIntellectual @close-dialog="closeIntellectualDialog" ></AddIntellectual>
              </el-dialog>
              
              <!--修改知识产权-->
              <el-dialog title="修改知识产权" v-model = "intellectualDialogVisibleEdit" destroy-on-close width="700px">
